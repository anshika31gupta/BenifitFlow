    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
        <motion.div
          ...
          className="w-full max-w-2xl bg-[#0d0d11] border border-blue-500/30 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl relative overflow-hidden"
        >
          {/* Glow ambient accent */}
            ...
            <div className="space-y-4">
              ...
              <div className="glass-panel p-4 rounded-xl border border-white/10 flex justify-between items-center text-xs font-mono">
                <div className="flex items-center gap-2 text-slate-400">
                  ...
                  <span>Est. Processing Time: 1-3 Days</span>
                </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-white/10">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 text-xs font-semibold disabled:opacity-40 flex items-center gap-1.5 cursor-pointer"
            >
            ...
            {currentStep < 4 ? (
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold flex items-center gap-2 shadow-[0_4px_15px_rgba(37,99,235,0.4)] cursor-pointer"
              >
                <span>Next Step</span>
              ...
              <motion.button
                ...
                className="px-8 py-3 rounded-2xl bg-gradient-to-r from-emerald-500 via-teal-600 to-emerald-600 hover:from-emerald-400 hover:to-teal-500 text-slate-950 font-extrabold text-xs sm:text-sm flex items-center gap-2 shadow-[0_10px_25px_-5px_rgba(16,185,129,0.5)] cursor-pointer transition-all"
              >
                {isSubmitting ? (
                  <>
