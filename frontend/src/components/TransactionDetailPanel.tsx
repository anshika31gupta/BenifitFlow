...
export const TransactionDetailPanel: React.FC<TransactionDetailPanelProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden flex justify-end bg-black/60 backdrop-blur-md transition-opacity">
      <div className="w-full max-w-lg bg-[#0d0d11] border-l border-white/10 h-full overflow-y-auto p-6 sm:p-8 space-y-6 shadow-2xl relative">
        {/* Top Header */}
        ...
        <div className="space-y-3">
          {!geminiExplanation ? (
            <button
              ...
              className="w-full bg-white/5 hover:bg-white/10 border border-blue-500/30 text-blue-300 font-semibold text-xs py-3 rounded-xl flex items-center justify-center gap-2 transition-all"
            >
        ...
        {transaction.hasBenefit && (
          <div className="pt-4 border-t border-white/10 space-y-2">
            <button
              ...
              className="w-full bg-gradient-to-r from-emerald-500 via-teal-600 to-emerald-600 hover:from-emerald-400 hover:to-teal-500 text-slate-950 font-extrabold text-sm py-3.5 rounded-2xl shadow-[0_10px_25px_-5px_rgba(16,185,129,0.4)] flex items-center justify-center gap-2 transition-all transform active:scale-95"
            >
